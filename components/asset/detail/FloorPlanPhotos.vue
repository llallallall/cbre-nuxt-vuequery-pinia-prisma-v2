        ...
        <ul class="cbre_bulletList font-calibreLight text-lg text-primary grid grid-cols-1 lg:grid-cols-2 3xl:grid-cols-2 ">
                <li class="flex items-center">
                        ...
                        <div class="relative w-full max-h-[600px] p-4 select-none">
                                ...
                                <div v-if="item.floorPlanPhotoList.logitudinal && item.floorPlanPhotoList.logitudinal.length > 0" 
                ...
                <li class="flex items-center">
                        ...
                        <div class="relative w-full max-h-[600px] p-4 select-none">
                                ...
                                <div v-if="item.floorPlanPhotoList.cross && item.floorPlanPhotoList.cross.length > 0" 
        ...
        <Disclosure defaultOpen>
                <DisclosureButton class="relative flex justify-between gap-3 w-full p-4 py-2 pr-0 select-none ">
                        ...
                        <div class="w-1/2 flex justify-end">
                                <div class="bg-primary/10 hover:bg-primary/25 
                                        ...
                                        {{  item.floorPlanPhotoList.eachFloor.uppers.length + item.floorPlanPhotoList.eachFloor.basements.length }}
                                </div>
                        </div>
                ...
                <DisclosurePanel class="w-full font-calibreLight text-lg text-primary ">
                        ...
                        <ul  
                                ...
                                <li v-if="item.floorPlanPhotoList.eachFloor.uppers.length > 0 " v-for="(floor, index) in item.floorPlanPhotoList.eachFloor.uppers" :key="index"
                                        ...
                                        <div 
                                                ...
                                                <div class="absolute top-0 right-0 text-primary hover:text-white backdrop-blur-sm bg-white/25 hover:bg-primary/75"
                                                  @click="()=> {currentImgUrl=floor.fileUrl; open();}"      >
                                                        <IconExpand />
                                                </div> 
                                                <div 
                                                        class="mt-[30px] flex-1 flex flex-col">
                                ...
                                <li v-if=" item.floorPlanPhotoList.eachFloor.basements.length > 0" v-for="(floor, index) in item.floorPlanPhotoList.eachFloor.basements" :key="index"
                                        class="relative flex items-center ml-8">
