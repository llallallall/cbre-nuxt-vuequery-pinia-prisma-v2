        ...
        <div v-if="item?.historyList" >       
                        ...
                        <ul 
                                ...
                                <li class="flex items-center" v-for="(history, index) in item.historyList" :key="history">
                                        <div v-if="history.type == 'COMPLETION' && Number(history.year) > 0" class="w-full flex items-center">
                                        ...
                                        <div v-if="history.type == 'RENOVATION' && Number(history.year) > 0" class="w-full flex items-center">
                                                <IconMinus class="w-[18px] mr-1" />
                                                <div class="min-w-[130px] whitespace-nowrap text-right mr-4 font-calibre">
