...
const storeFileData = async (response: any) => {
        ...
        //         let originFileUrl = '';
        //         try {
        //                 await useFetch('/api/upload/localFile', {
        //                 method: 'POST',
        //                 body : formData,
        //                 onResponse(context) {
        ...
        //         let file = new Object() as FileType
        //         file.fileUuid = fileData.uuid;
        //         file.fileContentType = fileData.obj.type;
        //         file.fileName = fileData.name;
        //         file.fileKey = key;
        //         file.fileUrl = originFileUrl;
                
        //         brochureList.value = []
        //         brochureList.value.push(file)
        ...
        //         currentPdfFilePath.value = brochureList.value[0].fileUrl ? brochureList.value[0].fileUrl : '/sample/files/empty.pdf'         
...
const handleSubmit = async () => {
        ...
        try {
                ...
                const { data, error, status } = await useFetch('/api/upload/uploadDatabase', {
                                        method: "POST",
                                        body: {
