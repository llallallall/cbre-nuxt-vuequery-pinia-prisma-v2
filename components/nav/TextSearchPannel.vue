<template>
        <div class="flex flex-col w-full h-full z-20">
                <div class="w-full flex flex-col justify-start items-start px-6">
                        ...
                        <p class="hidden 4xs:flex text-base font-financier text-primary">You can search for an asset by its
                                name, administrative
                                district, or city.</p>
                        ...
                        <li class="flex flex-col">
                                <div class="flex items-center w-full h-full">
                                        ...
                                        <div class="input-wrapper relative flex-1 flex ">
                                                <input v-model="filterStore.searchKeyword" type="text" name="search" class="peer 
                                                search-input-pannel relative flex-1
                                        ...
                                        <div class="magnifier flex " @click="onSearchText()">
...
const { searchKeyword } = storeToRefs(useFilterStore());
const onSearchText = () => {
