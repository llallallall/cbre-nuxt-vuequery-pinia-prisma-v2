...
export const useExcel = () => {
    const downloadExcel = async (properties: PropertyType[]) => {
        ...
        // --- Helper: Apply Premium Header Style ---
        const applyHeaderStyle = (sheet: Excel.Worksheet) => {
            const headerRow = sheet.getRow(1);
            headerRow.height = 30; // Slightly taller for premium feel
            headerRow.eachCell((cell) => {
                cell.fill = {
                    type: 'pattern',
                    pattern: 'solid',
                    fgColor: { argb: 'FF006A4D' }, // CBRE Green
                };
                cell.font = {
                    name: 'Times New Roman', // Consistent with original useExcel
                    bold: true,
        ...
        const applyDataRowStyle = (sheet: Excel.Worksheet) => {
            sheet.eachRow((row, rowNumber) => {
                if (rowNumber > 1) {
                    ...
                    row.eachCell((cell) => {
                        ...
                        cell.alignment = {
                            vertical: 'middle',
                            horizontal: 'center', // Default center
                            wrapText: true,
                        };
                        cell.border = {
                            top: { style: 'thin', color: { argb: 'FFD9D9D9' } }, // Light gray border
        ...
        // Map to store property ID to Number mapping for consistency across sheets
        ...
        sheetGeneral.columns = [
            ...
            { header: 'Property Name', key: 'name', width: 35 },
        ...
        applyDataRowStyle(sheetGeneral);


        // =================================================================================================
        // 2. History Info Sheet
        // =================================================================================================
        const sheetHistory = workbook.addWorksheet('History Info');
        ...
        applyDataRowStyle(sheetHistory);
        ...
        applyDataRowStyle(sheetFloor);


        // =================================================================================================
        // 4. Floor Partial Info Sheet
        // =================================================================================================
        ...
        applyDataRowStyle(sheetFloorPartial);
