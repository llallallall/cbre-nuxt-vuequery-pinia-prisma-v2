...
export default eventHandler(async (event) => {
        ...
        // 8)  floor
        let upperFloorListResult = body.values.floorList.uppers
        ...
        let basementFloorListResult = body.values.floorList.basements
        ...
        console.log(body.values.floorPlanPhotoList.logitudinal);

        console.log(body.values.floorPlanPhotoList.cross);

        console.log(body.values.floorPlanPhotoList.eachFloor.uppers);

        console.log(body.values.floorPlanPhotoList.eachFloor.basements);

        console.log(body.values.brochureList);
